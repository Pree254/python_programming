...
print("updated s1: ", s1)
 ...
 # Clearing elements for a set
s3.clear()

print("Cleared s3- should be an empty set: ", s3)
# Making shallow copy of the original set 2
...
print("Set1 intersection set2-using & operator: ", set7)
print("Set1 intersection set2-using intersection function: ", set8)
...
print("Set9 difference set10-using different function : ", set12)

# set symetric differences
set13 = {1, 3, 5, 7, 9}
set14 = {1, 5, 8, 10, 12}
print("set13 ", set13)
print("set14 ", set14)
...
print("Set13 symmetric difference set 14-using ^ operator: ", set15)
print("Set13 symmetric difference set 14-using symmetric difference function: ", set16)
